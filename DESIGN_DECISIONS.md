...
##### ❌ NOT because:
- ~~kube-reserved would "starve" static pods~~ (FALSE - static pods are outside kubelet.slice)
- ~~It would cause cluster instability~~ (No evidence in official Kubernetes documentation)
...
- **2025-01-16**: Initial documentation - MacFlurry
- **Rationale**: Clarify that this is a conservative choice, not a technical limitation
